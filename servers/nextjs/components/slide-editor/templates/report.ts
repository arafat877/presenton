...
function cardBodySources(count: number) {
  return Array.from({ length: count }, (_, index) => `cards[${index}].body`);
}

function cardRoleSources(count: number) {
  return Array.from({ length: count }, (_, index) => [
    `cards[${index}].title`,
    `cards[${index}].role`,
  ]).flat();
...
function metricSummarySources(count: number) {
  return Array.from({ length: count }, (_, index) => [
    `metrics[${index}].value`,
    `metrics[${index}].label`,
  ]).flat();
...
export const reportGenerationLayouts = [
  ...
  },
  {
    ...
    bindings: textBindings(["title", ...cardBodySources(2)]),
  },
  {
    ...
    bindings: textBindings(["title", ...timelineSources(5)]),
  },
  {
  ...
  },
  {
    ...
    bindings: textBindings(["title", ...cardSources(3), "chart.title"]),
  },
  {
    ...
    bindings: textBindings(["title", "summary", "chart.title"]),
  },
  {
  ...
  },
  {
    ...
    bindings: textBindings(["title", ...metricSources(6)]),
  },
  {
    ...
    bindings: textBindings(["title", ...cardSources(4)]),
  },
  {
    ...
    bindings: textBindings(cardRoleSources(5)),
  },
  {
    ...
    bindings: textBindings(["title", ...metricSummarySources(4)]),
  },
