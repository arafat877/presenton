/**
 * Neo-modern layout: title, description, metrics, and charts in a responsive grid.
 */
...
export const layoutDescription = 'A neo-modern dashboard with title, description, KPI metrics, and auto-arranged charts. Supports bar (vertical, horizontal, grouped, stacked, clustered, diverging), line, area, pie, donut, and scatter charts.';
