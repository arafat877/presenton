...
export const layoutDescription = "A slide featuring a title, description, and metrics grid on the left with a large vertical image on the right. The alternating metric cards create visual hierarchy.";
