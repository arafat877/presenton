/**
 * Neo-standard layout: title, description, bullets, and charts in a responsive grid.
 */
...
export const layoutDescription = 'A neo-standard dashboard with title, description, bullet points, and auto-arranged charts. Supports bar (vertical, horizontal, grouped, stacked, clustered, diverging), line, area, pie, donut, and scatter charts.';
