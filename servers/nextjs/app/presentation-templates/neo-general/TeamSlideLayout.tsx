...
export const layoutDescription = 'A split layout with title, accent line, and description on the left, paired with a flexible grid of person cards on the right. Each card displays photo, name, position, and bio.'
