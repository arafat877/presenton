...
export const layoutDescription =
  "A layout featuring a large left-aligned title with a icon bullet point grid, each with circular icon badge, title, and optional subtitle. A rounded supporting image sits on the right.";
